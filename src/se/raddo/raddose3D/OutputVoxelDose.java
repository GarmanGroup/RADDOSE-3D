...
public class OutputVoxelDose implements Output{
   ...
   *          {@link Output} class.
   */
  public OutputVoxelDose(final Map<Object, Object> properties) {
  ...
  public void close() {
    if (crystal == null) {
      System.err
          .println("OutputVoxelDose: No crystal object has been seen.");
      w.write("OutputVoxelDose: No crystal object has been seen.");
      w.close();
      return;
    }
