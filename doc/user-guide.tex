...
\newcommand{\RE}{\texttt{RADDOSE-ED}\xspace}
\newcommand{\RX}{\texttt{RADDOSE-XFEL}\xspace}
...
\\[1.5em]
\noindent
For intensity decay models or doses for electron diffraction (\RE), please cite:\\[0.4em]
\href{https://doi.org/10.1002/pro.5005}{\large\textbf{Doses for X-ray and electron diffraction: New features in \RD including intensity decay models}}\\[0.1em]
\href{https://doi.org/10.1002/pro.5005}{Dickerson J. L.; McCubbin P. T. N.; Brooks-Bartlett, J. C., \& Garman, E. F. (2024). \textit{Protein Science} \textbf{33} %, ??--??
}\\[0.1em]
\href{https://doi.org/10.1002/pro.5005}{doi.org/10.1002/pro.5005}
\\[1.5em]
\noindent
If calculating doses for X-ray Free-Electron Lasers (\RX), please cite:\\[0.4em]
\href{https://doi.org/10.1107/S1600576720000643}{\large\textbf{\RX: femtosecond time-resolved dose estimates for macromolecular X-ray free-electron laser experiments}}\\[0.1em]
\href{https://doi.org/10.1107/S1600576720000643}{Dickerson J. L.; McCubbin P. T. N., \& Garman, E. F. (2020). \textit{J. Appl. Cryst.} \textbf{53} %, ??--??
}\\[0.1em]
\href{https://doi.org/10.1107/S1600576720000643}{doi.org/10.1107/S1600576720000643}
\\[1.5em]
\noindent
If using microcrystals or microbeams, we recommend using the Monte Carlo simulations outlined in:\\[0.4em]
\href{https://doi.org/10.1002/pro.3922}{\large\textbf{Doses for experiments with microbeams and microcrystals: Monte Carlo simulations in \RD}}\\[0.1em]
\href{https://doi.org/10.1002/pro.3922}{Dickerson J. L.\& Garman, E. F. (2020). \textit{Protein Science} \textbf{30} %, ??--??
}\\[0.1em]
\href{https://doi.org/10.1002/pro.3922}{doi.org/10.1002/pro.3922}
\\[1.5em]
\noindent
...
\\[1.5em]
\noindent
For developments in \RD, including the ability to incorporate experimental profiles and irregular polyhedral crystal geometries, as well as the inclusion of  models for energy loss from the crystal volume due to the Compton effect, please additionally refer to:\\[0.4em]
...
\\[1.5em]
\noindent
If there are heavy atoms present in the sample, it may be more accurate to simulate fluorescent escape, with the implementation detailed in:\\[0.4em]
\href{https://doi:10.1021/acs.jpca.1c05759}{\large\textbf{Structural and Electronic Effects of X-ray Irradiation on Prototypical [M(COD)Cl]2 Catalysts}}\\[0.1em]
\href{https://doi:10.1021/acs.jpca.1c05759}{Fernando, N. K. et al. (2021). \textit{The Journal of Physical Chemistry A} \textbf{125} %, ??--??
}\\[0.1em]
\href{https://doi:10.1021/acs.jpca.1c05759}{doi:10.1021/acs.jpca.1c05759}
\\[1.5em]
...
\subsection{\Keyword{DDM}}
\label{DDM}
\noindent \Keyword{DDM \textit{S}}
specifies the dose decay model used by RADDOSE-3D.
If no DDM is specified, no intensity decay is mdoelled by deault.

\noindent \Keyword{DDM LEAL} uses the Leal model (Leal RM, Bourenkov G, Russi S, Popov AN. J Synchrotron Radiat. 2013 Jan;20(Pt 1):14-22) which requires three parameters:
\noindent \Keyword{DECAYPARAM \textit{F F F}}
which are the $\gamma$, $B_0$, and $\beta$ parameters, respectively.
...
Specifies the number of photons to use in the simulations. \SB

\noindent \Keyword{SUBPROGRAM EMED}

Specifies that the RADDOSE-ED subprogram should be run, which calcualtes doses for MicroED experiments.

In the beam block, a further input is required:

\noindent \Keyword{EXPOSURE \textit{F}}
 
Specifies the total fluence in e\textsuperscript{-}/{\AA}\textsuperscript{2}\SB
