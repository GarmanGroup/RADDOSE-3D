		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.bugList-level1-label, .bugList-level2-label, .bugList-level3-label,
         ...
         window.onload = function(){
            init();
				...
				<script type='text/javascript'>
					...
					// class stats fields: class name, package name, isInterface, total
					...
					// package stats fields: package name, total bugs, bugs p1, bugs p2,
					bugs p3, bugs p4
					...
					// bugs fields: bug id, category id, code id, pattern id, priority,
					release id, class name, packagename (populated by javascript)
					var bugs = new Array(
					...
					// bugs fields: bug id, category id, code id, pattern id, priority,
					first release id, fixed release id, class name
